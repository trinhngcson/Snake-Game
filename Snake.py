...
score = 0
direction = 'down'
lb = Label(win, text = "Score:{}".format(score),font=('consolas',40))
lb.pack()

btnRePlay = Button(win, text= "Reset", font=('consolas',20), command=reset)
btnRePlay.pack(side="top")
